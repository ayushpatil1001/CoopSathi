...
export const MultilingualDemo: React.FC<MultilingualDemoProps> = ({
  ...
  const sampleConversations: Record<LanguageCode, DemoDialogue> = {
    ...
    gu: {
      userQuestion: 'શું હું પ્રધાનમંત્રી ફસલ બીમા યોજના માટે પાત્ર છું?',
      aiAnswer: 'હા! તમામ જમીનધારક ખેડૂતો અને ભાગીદાર ખેડૂતો અધિસૂચિત પાકો માટે પાત્ર છે. ખરીફ પાકો માટે માત્ર ૨% અને રવિ પાકો માટે ૧.૫% પ્રીમિયમ છે.',
      source: 'પીએમએફબીવાય માર્ગદર્શિકા ૨૦૨૪ (કલમ ૪.૧)',
      phoneticTip: 'ગુજરાતી બોલીઓ અને કૃષિ વિષયક પદોની સરળ ઓળખ.',
    },
    bn: {
