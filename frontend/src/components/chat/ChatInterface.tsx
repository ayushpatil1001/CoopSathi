...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  const suggestedQuestions: Record<LanguageCode, string[]> = {
    ...
    gu: [
      'સહકારી મંડળીના સભ્ય તરીકે મારા કયા કાનૂની અધિકારો છે?',
      'હું કઈ સરકારી યોજનાઓ માટે પાત્ર છું?',
      'પ્રધાનમંત્રી ફસલ બીમા યોજના માટે કેવી રીતે અરજી કરવી?',
      'સહકારી મંડળી વિરુદ્ધ ફરિયાદ કેવી રીતે નોંધાવવી?',
      'પેક્સ (PACS) દ્વારા ખેડૂતોને કઈ સેવાઓ મળે છે?'
    ],
    bn: [
